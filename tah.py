...
classes = []
with open('E:/43/Pattern_off/off_2/Supplied/Supplied/trainNN.txt') as file:
    train_data = []
    for i in file:
...
with open('E:/43/Pattern_off/off_2/Supplied/Supplied/testNN.txt') as file:
    test_data = []
    for i in file:
        data = [float(j) for j in i.split()]
...
layout = [len(train_features[0]), 8, len(train_labels[0])]
...
def train():
    ...
    for epoch in range(50000):
        ...
        delta_last = (y_hat - train_labels) * derivative(y_hat)
